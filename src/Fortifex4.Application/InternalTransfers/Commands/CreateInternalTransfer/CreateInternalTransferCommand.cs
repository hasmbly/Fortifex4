...
{
    public class CreateInternalTransferCommand : IRequest<CreateInternalTransferResult>
    {
    ...
    public class CreateInternalTransferCommandHandler : IRequestHandler<CreateInternalTransferCommand, CreateInternalTransferResult>
    {
        ...
        public async Task<CreateInternalTransferResult> Handle(CreateInternalTransferCommand request, CancellationToken cancellationToken)
        {
            CreateInternalTransferResult result = new CreateInternalTransferResult();
