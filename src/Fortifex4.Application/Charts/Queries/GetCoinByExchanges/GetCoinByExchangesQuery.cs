...
{
    public class GetCoinByExchangesQuery : IRequest<GetCoinByExchangesResult>
    {
        public string MemberUsername { get; set; }
        public int CurrencyID { get; set; } = 0;
    }

    public class GetCoinByExchangesQueryHandler : IRequestHandler<GetCoinByExchangesQuery, GetCoinByExchangesResult>
    {
        ...
        public async Task<GetCoinByExchangesResult> Handle(GetCoinByExchangesQuery request, CancellationToken cancellationToken)
        {
            ...
            var result = new GetCoinByExchangesResult
            {
