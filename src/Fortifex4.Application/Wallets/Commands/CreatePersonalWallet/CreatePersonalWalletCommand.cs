...
{
    public class CreatePersonalWalletCommand : IRequest<int>
    {
    ...
    public class CreatePersonalWalletCommandHandler : IRequestHandler<CreatePersonalWalletCommand, int>
    {
        ...
        public async Task<int> Handle(CreatePersonalWalletCommand request, CancellationToken cancellationToken)
        {
