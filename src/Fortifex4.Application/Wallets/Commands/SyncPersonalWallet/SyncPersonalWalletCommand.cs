...
{
    public class SyncPersonalWalletCommand : IRequest
    {
        public int WalletID { get; set; }
    }

    public class SyncPersonalWalletCommandHandler : IRequestHandler<SyncPersonalWalletCommand>
    {
        ...
        public async Task<Unit> Handle(SyncPersonalWalletCommand request, CancellationToken cancellationToken)
        {
