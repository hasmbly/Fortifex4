...
{
    public class GetWalletsBySameUsernameAndBlockchainQuery : IRequest<GetWalletsBySameUsernameAndBlockchainResult>
    {
        public int WalletID { get; set; }
    }

    public class GetWalletsBySameUsernameAndBlockchainQueryHandler : IRequestHandler<GetWalletsBySameUsernameAndBlockchainQuery, GetWalletsBySameUsernameAndBlockchainResult>
    {
        ...
        public async Task<GetWalletsBySameUsernameAndBlockchainResult> Handle(GetWalletsBySameUsernameAndBlockchainQuery query, CancellationToken cancellationToken)
        {
            var result = new GetWalletsBySameUsernameAndBlockchainResult();
