...
{
    public class CreateDepositCommand : IRequest<CreateDepositResult>
    {
    ...
    public class CreateDepositCommandHandler : IRequestHandler<CreateDepositCommand, CreateDepositResult>
    {
        ...
        public async Task<CreateDepositResult> Handle(CreateDepositCommand request, CancellationToken cancellationToken)
        {
            CreateDepositResult result = new CreateDepositResult();
