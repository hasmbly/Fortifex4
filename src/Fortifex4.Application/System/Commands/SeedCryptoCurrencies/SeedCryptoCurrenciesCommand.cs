...
{
    public class SeedCryptoCurrenciesCommand : IRequest<SeedCryptoCurrenciesResult>
    {
    }

    public class SeedCryptoCurrenciesCommandHandler : IRequestHandler<SeedCryptoCurrenciesCommand, SeedCryptoCurrenciesResult>
    {
        ...
        public async Task<SeedCryptoCurrenciesResult> Handle(SeedCryptoCurrenciesCommand request, CancellationToken cancellationToken)
        {
            var result = new SeedCryptoCurrenciesResult();
