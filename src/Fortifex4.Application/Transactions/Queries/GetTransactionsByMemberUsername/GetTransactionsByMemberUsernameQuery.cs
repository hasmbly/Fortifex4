...
{
    public class GetTransactionsByMemberUsernameQuery : IRequest<GetTransactionsByMemberUsernameResult>
    {
        public string MemberUsername { get; set; }
    }

    public class GetTransactionsByMemberUsernameQueryHandler : IRequestHandler<GetTransactionsByMemberUsernameQuery, GetTransactionsByMemberUsernameResult>
    {
        ...
        public async Task<GetTransactionsByMemberUsernameResult> Handle(GetTransactionsByMemberUsernameQuery query, CancellationToken cancellationToken)
        {
            ...
            var result = new GetTransactionsByMemberUsernameResult
            {
