...
{
    public class UpdatePersonalWalletCommand : IRequest
    {
    ...
    public class UpdatePersonalWalletCommandHandler : IRequestHandler<UpdatePersonalWalletCommand>
    {
        ...
        public async Task<Unit> Handle(UpdatePersonalWalletCommand request, CancellationToken cancellationToken)
        {
