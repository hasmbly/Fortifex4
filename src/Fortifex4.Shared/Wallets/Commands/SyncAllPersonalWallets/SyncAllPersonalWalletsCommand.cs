...
{
    public class SyncAllPersonalWalletsCommand : IRequest<SyncAllPersonalWalletsResult>
    {
    }

    public class SyncAllPersonalWalletsCommandHandler : IRequestHandler<SyncAllPersonalWalletsCommand, SyncAllPersonalWalletsResult>
    {
        ...
        public async Task<SyncAllPersonalWalletsResult> Handle(SyncAllPersonalWalletsCommand request, CancellationToken cancellationToken)
        {
            var result = new SyncAllPersonalWalletsResult();
