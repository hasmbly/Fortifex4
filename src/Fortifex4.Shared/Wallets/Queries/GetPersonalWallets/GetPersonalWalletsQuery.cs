...
{
    public class GetPersonalWalletsQuery : IRequest<GetPersonalWalletsResult>
    {
        public string MemberUsername { get; set; }
    }

    public class GetPersonalWalletsQueryHandler : IRequestHandler<GetPersonalWalletsQuery, GetPersonalWalletsResult>
    {
        ...
        public async Task<GetPersonalWalletsResult> Handle(GetPersonalWalletsQuery query, CancellationToken cancellationToken)
        {
            ...
            GetPersonalWalletsResult result = new GetPersonalWalletsResult
            {
