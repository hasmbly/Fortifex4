...
namespace Fortifex4.Application.Currencies.Commands.UpdateCryptoCurrencies
{
    ...
    public class UpdateCryptoCurrenciesCommandHandler : IRequestHandler<UpdateCryptoCurrenciesCommand, UpdateCryptoCurrenciesResult>
    {
        ...
        public async Task<UpdateCryptoCurrenciesResult> Handle(UpdateCryptoCurrenciesCommand request, CancellationToken cancellationToken)
        {
            var result = new UpdateCryptoCurrenciesResult();
