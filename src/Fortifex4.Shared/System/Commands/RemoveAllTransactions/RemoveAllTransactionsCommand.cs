...
{
    public class RemoveAllTransactionsCommand : IRequest<int>
    {
    }

    public class RemoveAllTransactionsCommandHandler : IRequestHandler<RemoveAllTransactionsCommand, int>
    {
        ...
        public async Task<int> Handle(RemoveAllTransactionsCommand request, CancellationToken cancellationToken)
        {
