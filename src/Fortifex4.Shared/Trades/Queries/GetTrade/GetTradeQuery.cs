...
{
    public class GetTradeQuery : IRequest<GetTradeResult>
    {
        public int TradeID { get; set; }
    }

    public class GetTradeQueryHandler : IRequestHandler<GetTradeQuery, GetTradeResult>
    {
        ...
        public async Task<GetTradeResult> Handle(GetTradeQuery query, CancellationToken cancellationToken)
        {
