...
{
    public class UpdatePreferredFiatCurrencyCommand : IRequest
    {
        public string MemberUsername { get; set; }
        public int PreferredFiatCurrencyID { get; set; }
    }

    public class UpdatePreferredFiatCurrencyCommandHandler : IRequestHandler<UpdatePreferredFiatCurrencyCommand>
    {
        ...
        public async Task<Unit> Handle(UpdatePreferredFiatCurrencyCommand request, CancellationToken cancellationToken)
        {
