...
namespace Fortifex4.Infrastructure.Persistence.Configurations
{
    public class CurrencyConfiguration : IEntityTypeConfiguration<Currency>
    {
        public void Configure(EntityTypeBuilder<Currency> builder)
        {
            ...
            builder.Property(e => e.UnitPriceInUSD).HasColumnType(SQLServerDataType.Decimal2918).IsRequired(); //CMC setidaknya butuh 5 digit di depan koma. Kita jaga-jaga ada 9 digit.
